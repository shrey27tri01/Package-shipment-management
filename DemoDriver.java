...
public class DemoDriver implements AppControl {
	...
	public static void main(String[] args) {
		...
		// demoFactories.add(new demo19064.FactoryDemo());
		// demoFactories.add(new base_19082.Factory_19082());
		demoFactories.add(new demo19003.FactoryDemo());
		// demoFactories.add(new demo19031.FactoryDemo());
